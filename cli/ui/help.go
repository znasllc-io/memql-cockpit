...
func (h *HelpOverlay) Draw(screen *Screen, bounds Rect) {
	...
	entries := []helpEntry{
		...
		{key: "F4 / " + alt + "+4", desc: "Skills"},
		{key: "F5 / " + alt + "+5", desc: "Workers"},
		{key: "F6 / " + alt + "+6", desc: "Safety"},
		{key: "F7 / " + alt + "+7", desc: "Bundles"},
		{key: "F8 / " + alt + "+8", desc: "Settings"},
		{},
		{section: "NAVIGATION"},
		{key: "Tab", desc: "Cycle focus between panes"},
		{key: "Ctrl+Q / Ctrl+C", desc: "Quit"},
		{key: "Ctrl+E", desc: "Computer-use kill switch (any tab)"},
